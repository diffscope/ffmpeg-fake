...
foreach(_target ${ffmpeg_subprojects})
    ...
    if (WIN32)
        file(GLOB _lib ${_IMPORT_PREFIX}/debug/lib/*${_target}*.lib)
        if ("${_lib}" STREQUAL "")
            message(FATAL_ERROR "Failed to find definition file of ${_target}.")
        endif()

        file(GLOB _dll ${_IMPORT_PREFIX}/debug/bin/*${_target}*.dll)
        if ("${_dll}" STREQUAL "")
    ...
    elseif (APPLE)
        file(GLOB _dylib ${_IMPORT_PREFIX}/debug/lib/*${_target}*.dylib)
        if ("${_dylib}" STREQUAL "")
            message(FATAL_ERROR "Failed to find definition file of ${_target}.")
        endif()
        ...
        if (IS_SYMLINK ${_dylib})
            ...
            if (IS_ABSOLUTE ${_symlink})
                ...
                set(_dylib ${_IMPORT_PREFIX}/debug/lib/${_symlink})
            endif()
        endif()
        ...
        file(GLOB _so ${_IMPORT_PREFIX}/debug/lib/*${_target}*.so)
        if ("${_so}" STREQUAL "")
            message(FATAL_ERROR "Failed to find shared library of ${_target}.")
        endif()
        ...
        if (IS_SYMLINK ${_so})
            ...
            if (IS_ABSOLUTE ${_symlink})
                ...
                set(_so ${_IMPORT_PREFIX}/debug/lib/${_symlink})
            endif()
        endif()
